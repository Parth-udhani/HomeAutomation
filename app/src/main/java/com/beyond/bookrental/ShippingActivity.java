...
public class ShippingActivity extends AppCompatActivity  implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp1 = getSharedPreferences("address_pref", MODE_PRIVATE);

        // Check if user details are saved in SharedPreferences
            // Auto-fill EditText views with saved user details
            name.setText(sp1.getString("fullName", ""));
            contact.setText(sp1.getString("mobileNo", ""));
            address.setText(sp1.getString("address", ""));
            city.setText(sp1.getString("city", ""));
            state.setText(sp1.getString("state", ""));
            pincode.setText(sp1.getString("pinCode", ""));
